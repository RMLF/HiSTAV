...
public:
    ...
    void importInfiltrationCoef(std::string&);
...
public:
    ...
    float constantRainfall;
    float infilParameter1;
    float infilParameter2;

	unsigned short numRainGauges;
    unsigned short infiltrationOption;

	bool useRainfall;
    bool useInfiltration;
